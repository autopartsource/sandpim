...
{// bail out if this is a clinet we don't like
 $logs = new logs;
 $logs->logSystemEvent('accesscontrol',0, 'exportWalmartSelect.php - access denied to host '.$_SERVER['REMOTE_ADDR']);
...
<html>
    ...
    <body>
        ...
        <div class="container-fluid padding my-container">
			...
			<!-- Header -->
                        <h3 class="card-header text-start">Export parts spreadsheet in Walmart Template format</h3>

                        <div class="card-body">
                            <form action="exportWalmartStream.php" method="get">
