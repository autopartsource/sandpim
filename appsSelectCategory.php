 ...
 <body>
  ...
  <form action="showAppsByBasevehicle.php">
   ...
   <div style="padding:20px;">
    <?php foreach($appcategories as $appcategory){echo '<div><input type="checkbox" id="appcategory_'.$appcategory['id'].'" name="appcategory_'.$appcategory['id'].'"><label for="appcategory_'.$appcategory['id'].'">'.$appcategory['name'].'</label></div>';}?>
