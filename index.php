                ...
                <div class="col-xs-12 col-md-8 my-col colMain">
                    <div class="card shadow-sm">
                        ...
                        <div class="card-body">
                            ...
                            {
                                echo '<div class="card"><h5 class="card-header text-left">Apps History</h5>'
                                . '<div class="card-body"><table><tr><th>Date/Time</th><th>User</th><th>AppID</th><th>Change Description</th></tr>';
                            ...
                            {
                                echo '<div class="card"><h5 class="card-header text-left">Assets History</h5>'
                                . '<div class="card-body"><table><tr><th>Date/Time</th><th>User</th><th>AssetID</th><th>Change Description</th></tr>';
                            ...
                            {
                                echo '<div class="card"><h5 class="card-header text-left">Parts History</h5>'
                                . '<div class="card-body"><table><tr><th>Date/Time</th><th>User</th><th>Partnumber</th><th>Change Description</th></tr>';
                            ...
                            {
                                echo '<div class="card"><h5 class="card-header text-left">System History</h5>'
                                . '<div class="card-body"><table><tr><th>Date/Time</th><th>User</th><th>Eventtype</th><th>Change Description</th></tr>';
