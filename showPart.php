                        ...
                        <div class="card-body">
                            ...
                            <div style="padding:10px;">
                                <table class="table" border="1" cellpadding="5">
                                    ...
                                    <?php if($balance){?> <tr><th>Balance</th><td>On-Hand: <b><?php echo round($balance['qoh'],0);?></b>, AMD: <b><?php echo $balance['amd'];?></b>, Std Cost: <b><?php echo $balance['cost'];?></b> Dollars</td><tr> <?php }?>
