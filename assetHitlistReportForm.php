...
{// bail out if this is a clinet we don't like
 $logs = new logs;
 $logs->logSystemEvent('accesscontrol',0, 'assetHitlistReportForm.php - access denied (404 returned) to client '.$_SERVER['REMOTE_ADDR']);
...
<html>
    ...
    <body>
        ...
        <div class="container-fluid padding my-container">
			...
			<!-- Header -->
                        <h3 class="card-header text-start">Report available parts missing specific types of assets</h3>
