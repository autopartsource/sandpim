...
$pim = new pim();
$jobs=$pim->getBackgroundjobs('ACES50xmlExport','started');
...
if(count($jobs))
{
 ...
 include_once(__DIR__.'/class/ACES5_0GeneratorClass.php');
 ...
 if(array_key_exists('SubBrandAAIAID', $keyedprofile)){$header['SubBrandAAIAID']=$keyedprofile['SubBrandAAIAID'];}
 ...
 if(!$doc->schemaValidate(__DIR__.'/ACES_5_0_XSDSchema_Rev4_3_16_2026.xsd'))
 {
