...
{
 $logs->logSystemEvent('accesscontrol',$_SESSION['userid'], 'partAttributesReportForm.php - access denied to host '.$_SERVER['REMOTE_ADDR']);
...
<html>
    ...
    <body>
        ...
        <div class="container-fluid padding my-container">
			...
			<!-- Header -->
                        <h3 class="card-header text-start">Report part attributes coverage by part number</h3>

                        <div class="card-body">
                            <form action="partAttributesReportStream.php" method="get">
