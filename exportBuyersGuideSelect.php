...
{// bail out if this is a clinet we don't like
 $logs = new logs;
 $logs->logSystemEvent('accesscontrol',0, 'exportBuyersGuideSelect.php - access denied (404 returned) to client '.$_SERVER['REMOTE_ADDR']);
...
<html>
    ...
    <body>
        ...
        <div class="container-fluid padding my-container">
			...
			<!-- Header -->
                        <h3 class="card-header text-start">Export Buyer's Guide spreadsheet</h3>
                        <div class="card-body">
                            <form action="exportBuyersGuideStream.php" method="post">
                                <div style="border:solid #808080 1px;margin:20px;padding:10px;background-color: #f0f0f0">
                                    ...
                                    <div style="padding:8px;">Price Sheet <select name="pricesheetnumber"><option value="">Do not include prices</option><?php foreach($pricesheets as $pricesheet){echo '<option value="'.$pricesheet['number'].'">'.$pricesheet['description'].'</option>';}?></select></div>
