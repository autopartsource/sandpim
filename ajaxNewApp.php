...
if(isset($_GET['basevehicleid']) && isset($_GET['quantityperapp']) && isset($_GET['partnumber']) && isset($_GET['appcategory']) && isset($_GET['cosmetic']) && isset($_GET['fitment']) && isset($_GET['positionandparttype']))
{
...
//$fp = fopen('./logs/log.txt', 'a');fwrite($fp, $basevehicleid.','.$parttypeid.','.$positionid.','.$quantityperapp.','.$partnumber.','.$appcategory.','.$cosmetic."\n");fclose($fp);
 ...
 $pim->newApp($basevehicleid,$parttypeid,$positionid,$quantityperapp,$partnumber,$appcategory,$cosmetic,$attributes);
}?>
