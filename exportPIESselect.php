        ...
        <div class="wrapper">
            ...
            <div style="padding:20px;border:1px solid blue;width:350px;">
                ...
                <?php foreach ($partcategories as $partcategory) {
                    echo '<div><input type="checkbox" id="partcategory_' . $partcategory['id'] . '" name="partcategory_' . $partcategory['id'] . '" checked><label for="partcategory_' . $partcategory['id'] . '">' . $partcategory['name'] . '</label></div>';
                } ?>
            </div>
