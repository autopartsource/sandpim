...
{// bail out if this is a clinet we don't like
 $logs = new logs;
 $logs->logSystemEvent('accesscontrol',0, 'exportACES50select.php - access denied (404 returned) to client '.$_SERVER['REMOTE_ADDR']);
...
<html>
    ...
    <body>
        ...
        <div class="container-fluid padding my-container">
			...
			<!-- Header -->
                        <h3 class="card-header text-start">Export ACES 5.0 xml - select source and options</h3>
                        <div class="card-body">
                            <form action="exportACES50createJob.php" method="post">
