                        ...
                        <div class="card-body">
                            ...
                            <div class="card text-start">
                                ...
                                <div class="card-body">
                                    ...
                                    <div style="padding:3px;">From Competitor <select name="competitivebrand"><option value="any">Any Brand</option><?php foreach($competitivebrands as $competitivebrand){echo '<option value="'.$competitivebrand['brandAAIAID'].'">'.$competitivebrand['description'].'</option>';}?></select></div>
                                    <div style="padding:3px;">Connected to our part that are <select name="parttypeid"><option value="any">Any Part Type</option><?php foreach($favoriteparttypes as $parttype){?> <option value="<?php echo $parttype['id'];?>" <?php if(isset($_GET['parttypeid']) && $_GET['parttypeid']==$parttype['id']){echo ' selected';}?>><?php echo $parttype['name'];?></option><?php }?></select></div>
