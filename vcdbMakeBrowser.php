...
<html>
    ...
    <body>
        ...
        <div class="container-fluid padding my-container">
			...
			<!-- Header -->
                        <h3 class="card-header text-start">Favorite VCdb Makes<div style="float:right"><a class="btn btn-secondary" href="vcdbMakeBrowser.php?searchtype=selected&searchterm=&submit=Search">Show only favorites</a></div></h3>
